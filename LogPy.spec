...
gui = Analysis(['logpy\\gui.py'], pathex=[], binaries=[], datas=[('README.md', '.'), ('logpy/guiutils/results-icon.ico', 'icons'), ('logpy/guiutils/analysis-icon.ico', 'icons')], hiddenimports=[], hookspath=[], hooksconfig={}, runtime_hooks=[], excludes=[], win_no_prefer_redirects=False, win_private_assemblies=False, cipher=block_cipher, noarchive=False,)
...
gui2 = Analysis(['logpy\\gui_devel.py'], pathex=[], binaries=[], datas=[('README.md', '.'), ('logpy/guiutils/results-icon.ico', 'icons'), ('logpy/guiutils/analysis-icon.ico', 'icons')], hiddenimports=[], hookspath=[], hooksconfig={}, runtime_hooks=[], excludes=[], win_no_prefer_redirects=False, win_private_assemblies=False, cipher=block_cipher, noarchive=False,)
