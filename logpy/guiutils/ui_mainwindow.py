...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionStorage = QAction(MainWindow)
        self.actionStorage.setObjectName(u"actionStorage")
        ...
        self.actionAIS140 = QAction(MainWindow)
        self.actionAIS140.setObjectName(u"actionAIS140")
        self.actionAIS140.setCheckable(True)
        self.actionCVP = QAction(MainWindow)
        self.actionCVP.setObjectName(u"actionCVP")
        self.actionCVP.setCheckable(True)
...
"color:white;")
        ...
        self.menuStorage = QMenu(self.menuModule)
        self.menuStorage.setObjectName(u"menuStorage")
        ...
        self.menuModule.addAction(self.menuStorage.menuAction())
        self.menuAll.addAction(self.actionNetwork)
        self.menuAll.addAction(self.actionSleep)
        self.menuAll.addAction(self.actionStorage)
        ...
        self.menuStorage.addAction(self.actionAIS140)
        self.menuStorage.addAction(self.actionCVP)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionStorage.setText(QCoreApplication.translate("MainWindow", u"Storage", None))
        ...
        self.actionAIS140.setText(QCoreApplication.translate("MainWindow", u"AIS140", None))
        self.actionCVP.setText(QCoreApplication.translate("MainWindow", u"CVP", None))
        ...
        self.menuStorage.setTitle(QCoreApplication.translate("MainWindow", u"Storage", None))
